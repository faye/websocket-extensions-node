...
var instance = {
  ...
  activate: function(header) {
    var responses = Parser.parseHeader(header),
        name, params, record, ext, session, reserved;
    ...
    for (var i = 0, n = responses.length; i < n; i++) {
      ...
      var reserved = this._reserved(ext);
      if (reserved)
  ...
  generateResponse: function(header) {
    ...
    this._inOrder.forEach(function(ext) {
      var offer = offers.filter(function(o) { return o.name === ext.name }).
                         map(function(o) { return o.params });
